...
L(2) = Link('revolute','alpha',pi/2,'a',L3,'d',0,'offset',pi/2,'modified', 'qlim',[-2*pi/3 2*pi/3]);
L(3) = Link('revolute','alpha',0,'a',L2,'d',0,'offset',0,'modified', 'qlim',[-2*pi/3 2*pi/3]);
L(4) = Link('revolute','alpha',pi/2,'a',L6,'d',L4,'offset',0,'modified', 'qlim',[-2*pi/3 2*pi/3]);
L(5) = Link('revolute','alpha',-pi/2,'a',0,'d',0,'offset',0,'modified', 'qlim',[-2*pi/3 2*pi/3]);
L(6) = Link('revolute','alpha',pi/2,'a',0,'d',L5,'offset',0,'modified', 'qlim',[-2*pi/3 2*pi/3]);
